...
export default function ModalForm(props){
  ...
  //   console.log('🔥🍅')
  //   setToggleModalState(' opacity-0 pointer-events-none ');
  //   setModalWrapper('modal-active');
  //   setInnerModalState(true);
  // }

  return (
    <div>
      <div className={props.toggle ? `modal-active ${modalcss} mx-auto` : `${modalcss} ${toggleModalState} mx-auto`}>
      ...
      <div className="modal-content py-4 text-left px-6">
        ...
        <div className="flex justify-end pt-2">
            <button className="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2">Save</button>
            <button className="modal-close px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400" onClick={props.toggleModal}>Cancel</button>
          </div>
